...
| **Pushover** | `check-certs-pushover.sh` | Any | Mobile push notifications with escalating priorities → [docs/pushover.md](docs/pushover.md) |
...
To add background monitoring after a manual install see [docs/macos-notify.md](docs/macos-notify.md) or [docs/webhook.md](docs/webhook.md).
...
To add background monitoring after a manual install see [docs/linux-email.md](docs/linux-email.md) or [docs/webhook.md](docs/webhook.md).
